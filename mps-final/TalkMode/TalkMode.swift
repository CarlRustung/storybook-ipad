...
class TalkMode: SKScene, ButtonDelegate {
    ...
    override init( size: CGSize ) {
        ...
        loadSceneJSON( "dialogueData" )
    }
    
    func initScene() { // CAUTION: MOST OF THIS DIFFERS BETWEEN STORYBOOK AND COMPANION, DO NOT COPY/PASTE
